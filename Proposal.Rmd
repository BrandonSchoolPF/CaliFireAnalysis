...
Admin unit- an indicator of location by who is responding, reporting or responsible for the fire and/or its data collection Most times if calfire is TRUE in CalFireIncident than it has calfire in admin unit
...
calFireIncident- calfire is a specific organization in California that responds to fire incidents. Most likely bigger ones not small house fires that local firefighters respond to. According to Admin Unit there are multiple units within California
