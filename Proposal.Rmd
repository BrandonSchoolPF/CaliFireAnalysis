...
This portion of the project will be taking the dataset and creating multiple geographical
representations of the data, that will not only provide a better look at the data itself, 
but will allow the viewer to infer where wildfires may more likely occur. 
